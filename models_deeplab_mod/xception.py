...
class Xception65(nn.Module):
    def __init__(self, output_stride=8):
        ...
        self.block8 = XceptionBlock([728, 728, 728, 728], dilation=middle_block_dilation, skip_connection_type='sum', low_feat=True)
        ...
        self.block14 = XceptionBlock([728, 728, 728, 728], dilation=middle_block_dilation, skip_connection_type='sum', low_feat=True)
    ...
    def forward(self, x):
        ...
        x = self.block1(x)
        x, low_level_feat = self.block2(x); #count+=1; print(count, x.shape); print(low_level_feat.shape)  # b, h//4, w//4, 256
        x = self.block3(x); #count+=1; print(count, x.shape)  # b, h//8, w//8, 728

        # Middle flow
        x = self.block4(x); #count+=1; print(count, x.shape)
        x = self.block5(x); #count+=1; print(count, x.shape)
        x = self.block6(x); #count+=1; print(count, x.shape)
        x = self.block7(x); #count+=1; print(count, x.shape)
        x, low_level_feat2 = self.block8(x); #count+=1; print(count, x.shape); print(low_level_feat.shape)
        x = self.block9(x); #count+=1; print(count, x.shape)
        x = self.block10(x); #count+=1; print(count, x.shape)
        x = self.block11(x); #count+=1; print(count, x.shape)
        x = self.block12(x); #count+=1; print(count, x.shape)
        x = self.block13(x); #count+=1; print(count, x.shape)
        x, low_level_feat3 = self.block14(x); #count+=1; print(count, x.shape); print(low_level_feat.shape)
        x = self.block15(x); #count+=1; print(count, x.shape)
        x = self.block16(x); #count+=1; print(count, x.shape)
        x = self.block17(x); #count+=1; print(count, x.shape)
        x = self.block18(x); #count+=1; print(count, x.shape)
        x = self.block19(x); #count+=1; print(count, x.shape)

        # Exit flow
        x = self.block20(x); #count+=1; print(count, x.shape)
        x = self.block21(x); #count+=1; print(count, x.shape)

        return x, low_level_feat, low_level_feat2, low_level_feat3
